                                        ...
                                        <div class="col-lg-7 col-9">
                                            <div class="banner_content overflow-hidden">
                                                ...
                                                <a class="btn btn-fill-out rounded-0 staggered-animation text-uppercase"
                                                   ...
                                                   data-animation="slideInLeft"
                                                   data-animation-delay="1.5s" target="{{ $banner['target'] }}">Xem ngay</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="heading_tab_header">
                                    <div class="heading_s2">
                                        <h4>Món ăn mới của chúng tôi</h4>
                                    </div>
                                ...
                                <div class="tab_slider">
                                    <div class="tab-pane fade show active" id="arrival" role="tabpanel"
                                        ...
                                        @if(isset($product_new) && count($product_new) > 0)
                                            ...
                                            @foreach($product_new as $key => $newProduct)
                                                @if($key < 5)
                                                <div class="item">
                                    ...
                                    <div class="tab-pane fade" id="sellers" role="tabpanel"
                                        ...
                                        @if(isset($product_sale) && count($product_sale) > 0)
                                            <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1"
                                             data-loop="false" data-margin="20"
                                             data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                            @foreach($product_sale as $key => $sale)
                                                @if($key < 5)
                                                    <div class="item">
                                                        <div class="product_wrap">
                    ...
                    <div class="col-lg-4">
                        <div class="icon_box icon_box_style1">
                            ...
                            <div class="icon_box_content">
                                <h5>Thay đổi tour linh hoạt</h5>
                                <p>Thoải mái thay đổi thời gian - tour nếu đủ điều kiện</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="icon_box icon_box_style1">
                            ...
                            <div class="icon_box_content">
                                <h5>Hoàn tiền tới 90%</h5>
                                <p>Chỉ cần thông báo trước từ 3-5 ngày để chúng tôi có thể kịp thay đổi.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
