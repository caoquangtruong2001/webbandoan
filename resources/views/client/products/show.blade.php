                            ...
                            <div class="product_description">
                                ...
                                <div class="product_sort_info">
                                    <ul>
                                        ...
                                        <li><i class="linearicons-sync"></i> Giao hàng siêu nhanh</li>
                                        <li><i class="linearicons-bag-dollar"></i> Nhiều hình thức thanh toán</li>
                                    </ul>
                                </div>
                            </div>
                            <hr/>
                            <div class="cart_extra">
                                <div class="cart-product-quantity">
                                    <div class="quantity">
                                        ...
                                        <input type="text" name="quantity"  value="1" title="Qty" class="qty js-number" size="4">
...
@section('client_script')
    <script type="text/javascript">
        ...
        $('.btn-addtocart').click(function(e){
            ...
            let $number = $('.js-number').val();
            $href = $href + '?qty='+$number;
            console.log($href);
