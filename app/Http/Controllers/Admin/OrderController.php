    ...
    public function update(Request $request, $id)
    {
        if (!hwa_check_permission('edit_order') || !$order = $this->order->with(['order_details'])->find($id)) {
            ...
            $validator = validator($request->all(), [
                ...
                'payment_status.required' => 'Trạng thái thanh toán là trường bắt buộc.',
                'payment_status.in' => 'Trạng thái thanh toán không hợp lệ.',
                'shipping_status.required' => 'Trạng thái đơn hàng là trường bắt buộc.',
                'shipping_status.in' => 'Trạng thái đơn hàng không hợp lệ.',
