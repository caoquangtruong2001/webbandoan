...
class HomeController extends Controller
{
     ...
     * @param News $news
     */
    public function __construct(Newsletter $newsletter, Banner $banner, Product $product, News $news)
    {
    ...
    public function index()
    {
        ...
        $product_new = $this->product->whereActive('published')->orderBy('id', 'desc')->get();
        $product_sale = $this->product->whereActive('published')->orderBy('sale', 'desc')->get();
        $product_trending = $this->product->whereActive('published')->orderBy('views', 'desc')->get();
